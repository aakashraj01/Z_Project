...
const SearchBar = ({ suggestions }) => {
  ...
  return (
    <div className="p-5">
      ...
      {/* search input  */}
      <div className="flex justify-between items-center w-full max-w-md mt-5 p-3 space-x-4 rounded-lg shadow-md mx-auto bg-white">
        <input
          ...
          ref={inputEl}
          className="outline-none focus:p-1 transition-all duration-150 ease-in border-none text-md text-gray-500"
          placeholder="Search"
        />
        <BiSearch size={20} />
      </div>
